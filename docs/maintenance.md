...
- Export workflow changes: update `src/app/api/signups/export/route.ts` and `src/components/print-list-client.tsx`.
...
- Verify `/print` filters and CSV export work for date/class/formType combinations.
